                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full border-separate" style={{ borderSpacing: 0 }}>
                                ...
                                <tr className="bg-parley-cream">
                                    ...
                                    <th className="border-b border-l border-parley-brown p-2 text-center bg-parley-brown text-white sm:sticky right-0 z-30" colSpan={4} style={{ minWidth: colWidth * 4 }}>TOTALES</th>
                                </tr>
                                <tr className="bg-parley-cream text-[10px] uppercase font-bold text-parley-brown">
                                    ...
                                    <th className="border-b border-l border-parley-gold/70 p-1 text-center bg-green-200 text-green-900 sm:sticky z-30" style={{ right: colWidth * 3, width: colWidth }}>CE</th>
                                    <th className="border-b border-l border-parley-gold/70 p-1 text-center bg-red-200 text-red-900 sm:sticky z-30" style={{ right: colWidth * 2, width: colWidth }}>CN</th>
                                    <th className="border-b border-l border-parley-gold/70 p-1 text-center bg-blue-200 text-blue-900 sm:sticky z-30" style={{ right: colWidth * 1, width: colWidth }}>TP</th>
                                ...
                                {paginatedColeadores.map((coleador, index) => {
                                    ...
                                    return (
                                        <tr key={coleador.id} className={`${rowBgColor} hover:bg-[#F2E8D9] transition-colors group`}>
                                            ...
                                            <td className={`border-b border-l border-parley-gold/50 p-2 text-center font-black text-green-900 text-lg sm:sticky z-20 ${ceBg} hover:bg-green-200 transition-colors group-hover:bg-green-200`} style={{ right: colWidth * 3 }}>{currentCE - currentAR}</td>
                                            <td className={`border-b border-l border-parley-gold/50 p-2 text-center font-black text-red-900 text-lg sm:sticky z-20 ${cnBg} hover:bg-red-200 transition-colors group-hover:bg-red-200`} style={{ right: colWidth * 2 }}>{currentCN}</td>
                                            <td className={`border-b border-l border-parley-gold/50 p-2 text-center font-black text-blue-900 text-lg sm:sticky z-20 ${tpBg} hover:bg-blue-200 transition-colors group-hover:bg-blue-200`} style={{ right: colWidth * 1 }}>{currentTP}</td>
                                            <td
