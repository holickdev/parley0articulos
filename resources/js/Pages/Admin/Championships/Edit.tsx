...
export default function Edit({ championship, coleadores }: { championship: Championship, coleadores: Coleador[] }) {
                        ...
                        <div className="bg-white p-6 shadow sm:rounded-lg">
                            <div className="flex justify-between items-center mb-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">Configura quiénes compiten en este evento.</p>
                                </div>
