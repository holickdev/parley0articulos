    ...
    return (
        <>
            ...
            <div className="bg-parley-cream text-black/50 dark:bg-black dark:text-white/50">
                ...
                />
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#0047FF] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:col-start-2 lg:justify-center">
                                <svg
                                    className="h-12 w-auto text-white lg:h-16 lg:text-[#0047FF]"
                                    viewBox="0 0 62 65"
                                    fill="none"
